...
Após a release ser confirmada, carregue `gmr-handover-protocol` e aplique o protocolo de finalização.
...
# <Delegação>
- **Entrada:** Chamado após o veredito `APROVADO` do `gmr-quality-reviewer`.
