...
- Documentar resultados usando o template `.agent/skills/test-engineer/resources/templates/test-execution-report.md`.
...
2. `.agent/skills/test-engineer/resources/templates/test-execution-report.md` → Base para o relatório de saída.
