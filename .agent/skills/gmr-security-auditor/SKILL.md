...
- Documentar achados usando o template `.agent/skills/gmr-security-auditor/resources/templates/security-report.md`.
...
3. `.agent/skills/gmr-backend-architect/references/patterns.md` → Guia de mitigação técnico.
4. `.agent/skills/gmr-security-auditor/resources/templates/security-report.md` → Base para o relatório de saída.
...
Ao concluir a auditoria, carregue `gmr-handover-protocol` e aplique o protocolo padronizado.

- **Sem falhas críticas:** Próximo agente é o **Gerente de Lançamentos** 📦 com `/gmr-release-manager`.
- **Com falhas ALTA ou CRÍTICA:** Retorne ao **Coder** 💻 com `/gmr-implementation-coder [Task_ID]` e o relatório de falhas para correção antes da release.
</Passos>
