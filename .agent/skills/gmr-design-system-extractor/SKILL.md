---
name: gmr-design-system-extractor
...
2. `.agent/skills/gmr-design-system-extractor/resources/templates/design-system-spec.md` → Template de saída obrigatório.

### L2: Referências de Design
3. `.agent/skills/gmr-frontend-designer/SKILL.md` → Para entender como o Designer usará estes dados.
...
Próximo agente: **Designer Frontend** 🎨 com `/gmr-frontend-designer` para criar a interface baseada no sistema extraído.
</Passos>
...
- ✅ **SEMPRE** salve os dados estruturados para que o `gmr-frontend-designer` possa ler e aplicar.
</Restrições>
