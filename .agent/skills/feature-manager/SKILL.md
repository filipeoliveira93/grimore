...
5. `.agent/skills/feature-templates/references/templates.md` → Templates de `index.md`, `state.md` e `MTxx.md` com convenções de nomenclatura.
</Contexto>
...
Ao concluir a estrutura da funcionalidade (index.md, state.md, MTxx.md criados e revisados), carregue `handover-protocol` e aplique o protocolo de passagem de bastão.

Próximo agente: **Coder** 💻 com `/implementation-coder [primeiro Task_ID]`.
</Instruções>
...
- ✅ **SEMPRE** use os templates de `feature-templates`.
- ✅ **SEMPRE** verifique se a feature depende de outra antes de planejar o MT01.
</Restrições>

# <Delegação>
- **Entrada:** Chamado pelo `requirements-engineer` após aprovação do `requirements.md`.
- **Templates:** Carregue `feature-templates` para criar a estrutura de diretórios e arquivos.
- **Saída:** Entregue ao `implementation-coder` com o `MTxx.md` pronto e o `state.md` inicializado.
</Delegação>
