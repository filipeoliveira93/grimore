...
Use `gmr-detect-manifest` para identificar a stack automaticamente.
...
Cada marco torna-se um arquivo separado seguindo o padrão do `gmr-feature-templates`.
...
- [ ] Estrutura legada identificada com `gmr-detect-manifest`
