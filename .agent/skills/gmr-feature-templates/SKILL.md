...
# <Delegação>
- **Entrada:** Chamada pelo `gmr-feature-manager` ao criar qualquer nova funcionalidade.
- **Saída:** Templates preenchidos e estrutura de diretório criada. Retorne ao `gmr-feature-manager`.
